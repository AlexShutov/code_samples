...
//                        return;
    ...
    public void onLocationChanged(Location location) {
        ...
        try{
            ...
            objParams.put("lat", location.getLatitude());
            objParams.put("lng", location.getLongitude());
//            objParams.put("location_name", "");
            String token = WorkforceApp.getInstance().getToken();
            RestClientUtils.post(this.mContext, "staffs/location_checkin", objParams, token, new JsonHttpResponseHandler() {
                @Override
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    Log.i(getClass().getName(), "Location track response:" + response.toString());
                }
