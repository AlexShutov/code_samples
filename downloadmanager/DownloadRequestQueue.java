...
import com.betcade.helper.LocalStorage;
...
final class DownloadRequestQueue {
    ...
    int getSequenceNumber() {
        int nextDownloadId = Prefs.getInt(LocalStorage.DOWNLOAD_ID_NEXT, 0) + 1;
        Prefs.putInt(LocalStorage.DOWNLOAD_ID_NEXT, nextDownloadId);
